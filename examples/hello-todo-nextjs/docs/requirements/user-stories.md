# user stories — hello-todo-nextjs

Stories are written from the perspective of a developer exercising the API directly
(e.g., via curl or an HTTP client) and from the perspective of a browser user loading
the home page.
...
As a user visiting the app in a browser,
I want the home page to display the current list of todos,
so that I can see all items without making a separate API call.
