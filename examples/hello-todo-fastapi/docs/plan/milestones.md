...
- US-007: reject empty or missing title → 422 validation_error
...
- persistent storage backend (SQLite or Postgres via SQLAlchemy 2 async)
- `GET /v1/todos?completed=true` filtering
- pagination on list endpoint
- Docker image and container deployment
- Alembic migrations (once persistent storage is added)
