# api specification — hello-todo-fastapi
...
| field | type | notes |
|---|---|---|
| `id` | string | opaque, server-assigned; 32-char hex |
| `title` | string | non-empty after trim; max 200 chars |
...
**example:**
```bash
curl http://localhost:8000/v1/todos/a3f2c1d4e5b6a7f8c9d0e1f2a3b4c5d6
```
...
| error responses | 422 `validation_error`, 404 `not_found` |

**example:**
```bash
curl -X PATCH http://localhost:8000/v1/todos/a3f2c1d4e5b6a7f8c9d0e1f2a3b4c5d6 \
  -H "Content-Type: application/json" \
  -d '{"completed":true}'
```
...
**example:**
```bash
curl -X DELETE http://localhost:8000/v1/todos/a3f2c1d4e5b6a7f8c9d0e1f2a3b4c5d6
```
