# functional specification — hello-todo-go
...
Ids are opaque strings generated server-side. Callers must not infer ordering or
...
- order of items is not guaranteed (map iteration order)
...
| completely unknown route | 404 (Gin default) |
