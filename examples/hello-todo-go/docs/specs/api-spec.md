# api specification — hello-todo-go
...
**example:**
```bash
curl http://localhost:8080/v1/todos/01HZ8XVK5BNPQ3RE7GFMWJ0ABC
```
...
**example:**
```bash
curl -X PATCH http://localhost:8080/v1/todos/01HZ8XVK5BNPQ3RE7GFMWJ0ABC \
  -H "Content-Type: application/json" \
  -d '{"completed":true}'
```
...
**example:**
```bash
curl -X DELETE http://localhost:8080/v1/todos/01HZ8XVK5BNPQ3RE7GFMWJ0ABC
```
